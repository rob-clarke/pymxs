...
if os.path.exists(pickle_path):
    with open(pickle_path,"rb") as f:
        data_16_5_t1 = pickle.load(f)

else:
    data_16_5_t1 = process_dir('../wind_tunnel_data/raw/2022-04-06/as16.5_prop',tare1,has_beta=True,use_april=True)
    data_16_5_t1 = data_16_5_t1.append(process_dir('../wind_tunnel_data/raw/2022-04-07/as16.5_prop',tare1,has_beta=True,use_april=True))
...
sel_16_5p = select_neutral(data_16_5_t1)
