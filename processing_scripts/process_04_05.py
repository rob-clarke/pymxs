...
tare1 = utils.tares.create_tare_from_dir('../wind_tunnel_data/2022-04-05/tare1')
...
data_10_t1 = process_dir('../wind_tunnel_data/2022-04-05/as10',tare1,has_beta=True)
data_12_5_t1 = process_dir('../wind_tunnel_data/2022-04-05/as12.5',tare1,has_beta=True)
data_15_t1 = process_dir('../wind_tunnel_data/2022-04-05/as15',tare1,has_beta=True)
data_17_5_t1 = process_dir('../wind_tunnel_data/2022-04-05/as17.5',tare1,has_beta=True)
data_20_t1 = process_dir('../wind_tunnel_data/2022-04-05/as20',tare1,has_beta=True)
